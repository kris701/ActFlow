...
{
	public class FetchItemsFromDatabaseExecutor : BaseWorker<FetchItemsFromDatabaseAction>
	{
		...
		public override async Task<WorkerResult> Execute(FetchItemsFromDatabaseAction act, ActScriptState state, CancellationToken token)
		{
