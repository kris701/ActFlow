...
{
	[JsonDerivedType(typeof(ConditionalUserAction), typeDiscriminator: nameof(ConditionalUserAction))]
	public class ConditionalUserAction : IAIAction, IAwaitInputAction
	{
		...
		public ConditionalUserAction(string name, string executorId, string userInput, string condition, string comparer, string trueActionName, string falseActionName)
		{
			Name = name;
			UserInput = userInput;
			Condition = condition;
